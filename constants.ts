...
export const PACKAGES: ProductPackage[] = [
  {
    ...
    price: 15000,
    originalPrice: 15000,
    description: '1 pack, try it first',
    deliveryText: 'With free delivery within Lagos only (except Badagry and Epe)',
    usageNote: 'Result best seen after 2 months of continuous usage',
  },
  {
    id: 'option-b',
  ...
  },
  {
    ...
    savingsText: 'Save ₦18,000',
    description: '9 packs | 6 Full months',
    deliveryText: 'Free Delivery Lagos only (except Badagry and Epe).',
    usageNote: 'Optimal result seen after 6 months',
  },
];
